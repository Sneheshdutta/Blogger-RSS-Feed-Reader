package com.bloggerfeed.android.scikn.api;
...
import com.bloggerfeed.android.scikn.BuildConfig;
import com.bloggerfeed.android.scikn.api.model.RssFeed;
import com.bloggerfeed.android.scikn.api.model.RssItem;
import com.bloggerfeed.android.scikn.api.model.database.DatabaseOpenHelper;
import com.bloggerfeed.android.scikn.api.model.database.table.RssFeedTable;
import com.bloggerfeed.android.scikn.api.model.database.table.RssItemTable;
import com.bloggerfeed.android.scikn.api.model.database.table.Table;
import com.bloggerfeed.android.scikn.api.network.GetFeedsNetworkRequest;
import com.bloggerfeed.android.scikn.api.network.NetworkRequest;
...
public class DataSource {
    ...
    public DataSource() {
        ...
        // .getSharedInstance() returns an instance of sciknApplication
        databaseOpenHelper = new DatabaseOpenHelper(sciknApplication.getSharedInstance(),
                rssFeedTable, rssItemTable);

        // 55:
        if (BuildConfig.DEBUG && true) {
            sciknApplication.getSharedInstance().deleteDatabase("scikn_db");
        }
    }
