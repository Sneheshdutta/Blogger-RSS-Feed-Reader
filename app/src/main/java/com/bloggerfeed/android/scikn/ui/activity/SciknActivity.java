package com.bloggerfeed.android.scikn.ui.activity;
...
import com.bloggerfeed.android.scikn.sciknApplication;
import com.bloggerfeed.android.scikn.R;
import com.bloggerfeed.android.scikn.api.DataSource;
import com.bloggerfeed.android.scikn.api.model.RssFeed;
import com.bloggerfeed.android.scikn.api.model.RssItem;
import com.bloggerfeed.android.scikn.ui.adapter.ItemAdapter;
import com.bloggerfeed.android.scikn.ui.adapter.NavigationDrawerAdapter;

/**
 * Created by namlu on 14-Jun-16.
 */
public class SciknActivity extends AppCompatActivity
        implements
    ...
    // 55: SciknActivity now implements its own lists
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set SciknActivity as ItemAdapter's delegate and data source.
        ...
        swipeRefreshLayout.setColorSchemeColors(ContextCompat.getColor(SciknActivity.this, R.color.primary));
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                // 55: Fetch a new feed and provide an in-line Callback interface to
                //      receive the results
                sciknApplication.getSharedDataSource().fetchNewFeed("http://feeds.feedburner.com/Scikn?format=xml",
                // sciknApplication.getSharedDataSource().fetchNewFeed("http://feeds.ign.com/ign/all?format=xml",
                        new DataSource.Callback<RssFeed>() {
                            ...
                            public void onSuccess(RssFeed rssFeed) {
                                ...
                                sciknApplication.getSharedDataSource().fetchItemsForFeed(rssFeed,
                            ...
                            @Override
                            public void onError(String errorMessage) {
                                Toast.makeText(SciknActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                                // 55: programmatically disable the refreshing animation
                                swipeRefreshLayout.setRefreshing(false);
                            }
                        });
        ...
        // Set SciknActivity (this) as NavigationDrawerAdapter's delegate
    ...
    @Override
    // Menus belong to controllers, which is handled by SciknActivity
    ...
    @Override
    // DrawerLayout is managed by SciknActivity, not NavigationDrawerAdapter, therefore
    // SciknActivity is responsible for closing the DrawerLayout
